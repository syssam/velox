...
func (Workspace) Annotations() []schema.Annotation {
	return []schema.Annotation{
		...
		// Principal is generated by velox: Workspace and User both rename
		// their Member edge to "relations" (graphql.InterfaceField), and
		// Member exposes a polymorphic `principal` over the two.
