...
`
	...
	snap := &Snapshot{
		...
		Generator: func(_ *gen.Graph) error { return nil },
	}
...
func TestMergeField(t *testing.T) {
	...
	mergeField("TestSchema", local, other)
...
func TestMergeEdge(t *testing.T) {
	...
	mergeEdge("TestSchema", local, other)
...
func TestIsBuildError(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "velox/load prefix",
			err:      errors.New("velox/load: # some error"),
			expected: true,
		},
		{
			name:     "syntax error",
