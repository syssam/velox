...
func (Group) Fields() []velox.Field { return nil }
...
func TestMarshalSchema(t *testing.T) {
	for _, u := range []velox.Interface{User{}, &User{}} {
...
func (InvalidEdge) Edges() []velox.Edge {
	return []velox.Edge{
...
func (InvalidUUID) Fields() []velox.Field {
	return []velox.Field{
...
func (WithDefaults) Fields() []velox.Field {
	return []velox.Field{
		field.Int("int").
			Default(1),
		field.Float("float").
...
func (WithDefaults) Edges() []velox.Edge {
	return nil
}

func (WithDefaults) Indexes() []velox.Index {
	return nil
}
...
func (HooksMixin) Fields() []velox.Field {
	return []velox.Field{
		field.String("boring"),
	}
}

func (HooksMixin) Edges() []velox.Edge {
	return []velox.Edge{
...
func (HooksMixin) Indexes() []velox.Index {
	return []velox.Index{
		index.Fields("boring").
			Edges("user"),
	}
...
func (HooksMixin) Hooks() []velox.Hook {
	return []velox.Hook{
		func(velox.Mutator) velox.Mutator { return nil },
		func(velox.Mutator) velox.Mutator { return nil },
	}
}
...
func (BoringPolicy) EvalMutation(context.Context, velox.Mutation) error { return nil }
func (BoringPolicy) EvalQuery(context.Context, velox.Query) error       { return nil }

type PrivacyMixin struct {
	mixin.Schema
}

func (PrivacyMixin) Policy() velox.Policy {
	return BoringPolicy{}
}
...
func (WithMixin) Mixin() []velox.Mixin {
	return []velox.Mixin{
		TimeMixin{},
		HooksMixin{},
		PrivacyMixin{},
...
func (WithMixin) Fields() []velox.Field {
	return []velox.Field{
		field.Int("field"),
	}
}

func (WithMixin) Edges() []velox.Edge {
	return []velox.Edge{
		edge.To("owner", User.Type),
	}
}

func (WithMixin) Indexes() []velox.Index {
	return []velox.Index{
		index.Fields("field").
			Edges("owner").
			Unique(),
...
func (WithMixin) Hooks() []velox.Hook {
	return []velox.Hook{
		func(velox.Mutator) velox.Mutator { return nil },
	}
}

func (WithMixin) Policy() velox.Policy {
	return BoringPolicy{}
}
