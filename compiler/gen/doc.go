...
//
// # Graph Structure (formerly graph/ package)
//
// The Graph, Type, Field, and Edge types live in this package (graph.go,
// type.go, type_field.go, type_edge.go). The old doc-only graph/ package has
// been removed; all documentation and implementation now resides here.
//
// The Graph type holds all entity definitions and provides validation:
//
//	type Graph struct {
//	    Nodes []*Type  // All entity types in the schema
//	}
//
// Each Type represents an entity:
//
//	type Type struct {
