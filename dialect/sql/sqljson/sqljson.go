...
// (returned by the path) is equal to the given argumvelox.
//
...
// (returned by the path) is not equal to the given argumvelox.
//
...
// (returned by the path) is greater than the given argumvelox.
//
...
// (returned by the path) is less than the given argumvelox.
//
...
// value (returned by the path) contains the given argumvelox.
//
...
// of a JSON (returned by the path) is equal to the given argumvelox.
//
...
// of a JSON (returned by the path) is not equal to the given argumvelox.
//
//	sqljson.LenEQ("a", 1, sqljson.Path("b"))
...
// Use sqljson.ValuePath for using a JSON value as an argumvelox.
...
// marshalArg stringifies the given argument to a valid JSON documvelox.
