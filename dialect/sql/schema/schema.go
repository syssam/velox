...
func (r ReferenceOption) ConstName() string {
	return strings.ReplaceAll(toTitle(strings.ToLower(string(r))), " ", "")
}

// toTitle converts a string to title case (capitalizes first letter of each word).
// This is a simple implementation for ASCII strings to avoid the deprecated strings.Title.
