...
func TestGenEdgeField_RendersDirectives(t *testing.T) {
	...
	edge.Annotations = map[string]any{graphql.AnnotationName: graphql.Annotation{Directives: []graphql.Directive{
		graphql.NewDirective("requiresScopes", map[string]any{"scopes": [][]string{{"posts:read"}}}),
	}}}
