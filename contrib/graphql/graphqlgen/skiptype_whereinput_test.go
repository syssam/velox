...
func TestSkipType_OnEdge_PreservesHasXxxWith(t *testing.T) {
	...
	customerEdge := &entgen.Edge{
		...
		Annotations: map[string]any{
			graphql.AnnotationName: graphql.Annotation{
				Skip:              graphql.SkipType, // hide from Order output
...
func TestSkipAll_StillSuppressesWhereInput(t *testing.T) {
	customer := &entgen.Type{
		...
		Annotations: map[string]any{
			...
			graphql.AnnotationName: graphql.Skip().Merge(graphql.Annotation{
				WhereInputFieldNames: []string{"country"},
			}),
		},
	}
...
func TestSkipTypeAndWhereInput_BothFlags(t *testing.T) {
	customer := &entgen.Type{
		...
		Annotations: map[string]any{
			graphql.AnnotationName: graphql.Skip(graphql.SkipType, graphql.SkipWhereInput).Merge(graphql.Annotation{
				WhereInputFieldNames: []string{"country"},
			}),
		},
	}
