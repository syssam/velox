...
func TestValidateResolverMappings_EmptyFieldName(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{graphql.Map("", "PublicGlAccount")},
		},
	}
	typ := &entgen.Type{
		Name:        "User",
...
func TestValidateResolverMappings_EmptyReturnType(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{graphql.Map("glAccount", "")},
		},
	}
	typ := &entgen.Type{
		Name:        "User",
...
func TestValidateResolverMappings_InvalidFieldName(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{graphql.Map("GlAccount", "PublicGlAccount")},
		},
	}
	typ := &entgen.Type{
		Name:        "User",
...
func TestValidateResolverMappings_DuplicateFieldName(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{
				graphql.Map("glAccount", "TypeA"),
				graphql.Map("glAccount", "TypeB"),
			},
		},
	}
	typ := &entgen.Type{
...
func TestValidateResolverMappings_ConflictWithExistingField(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{graphql.Map("email", "CustomEmail")},
		},
	}
	typ := &entgen.Type{
		Name: "User",
...
func TestGenEntityType_MapWithComment(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{
				graphql.Map("glAccount", "PublicGlAccount!").WithComment("The GL account associated with this entity."),
				graphql.Map("approver", "PublicUser").WithComment("The user who approved this entity."),
			},
		},
	}
	userType := &entgen.Type{
...
func TestGenEntityType_MapWithInlineArgsAndComment(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{
				graphql.Map("priceListItem(priceListId: ID!, currency: String)", "PriceListItem!").
...
func TestValidateResolverMappings_DuplicateInlineArgs(t *testing.T) {
	ann := map[string]any{
		"graphql": graphql.Annotation{
			ResolverMappings: []graphql.ResolverMapping{
				graphql.Map("item(id: ID!)", "Item"),
				graphql.Map("item(code: String!)", "Item"),
			},
		},
	}
	typ := &entgen.Type{
