		...
		typ := &entgen.Type{
			...
			Fields: []*entgen.Field{
				{Name: "title", Type: &field.TypeInfo{Type: field.TypeString}},
				{
					...
					Annotations: map[string]any{
						graphql.AnnotationName: &graphql.Annotation{Skip: graphql.SkipMutationCreateInput},
					},
				},
			},
			Annotations: map[string]any{},
		...
		typ := &entgen.Type{
			...
			Edges: []*entgen.Edge{
				{Name: "tags", Type: &entgen.Type{Name: "Tag"}},
				{
					...
					Annotations: map[string]any{
						graphql.AnnotationName: &graphql.Annotation{Skip: graphql.SkipMutationUpdateInput},
					},
				},
			},
			Annotations: map[string]any{},
...
func TestGenerator_FilterFields(t *testing.T) {
	...
	result := gen.filterFields(fields, graphql.SkipType)
	assert.Len(t, result, 1)
...
func TestGenerator_NodeImplementors(t *testing.T) {
	...
	t.Run("WithCustomInterfaces", func(t *testing.T) {
		userType := &entgen.Type{
			Name: "User",
			Annotations: map[string]any{
				graphql.AnnotationName: &graphql.Annotation{Implements: []string{"Auditable"}},
			},
		}
	...
	t.Run("ExplicitNodeInterface_NoDuplicate", func(t *testing.T) {
		userType := &entgen.Type{
			Name: "User",
			Annotations: map[string]any{
				graphql.AnnotationName: &graphql.Annotation{Implements: []string{"Node"}},
			},
		}
	...
	f := &entgen.Field{
		...
		Annotations: map[string]any{
			graphql.AnnotationName: &graphql.Annotation{
				Directives: []graphql.Directive{graphql.Deprecated("use new_name")},
			},
		},
	}
...
func TestRenderDirectives_Empty(t *testing.T) {
	...
	assert.Equal(t, "", renderDirectives([]graphql.Directive{}))
}

func TestRenderDirectives_Multiple(t *testing.T) {
	dirs := []graphql.Directive{
