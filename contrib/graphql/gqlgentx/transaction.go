...
// Example:
//
//	gqlgentx.Transactioner{
//	    TxOpener:   client,
//	    SkipTxFunc: gqlgentx.SkipOperations("introspection"),
//	}
...
//	gqlgentx.Transactioner{
//	    TxOpener:   client,
//	    SkipTxFunc: gqlgentx.SkipIfHasFields("logout"),
//	}
...
func (t Transactioner) Validate(graphql.ExecutableSchema) error {
	if t.TxOpener == nil {
		return errors.New("gqlgentx: tx opener is nil")
	}
	return nil
}
