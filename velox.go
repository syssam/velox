...
// GraphQL and gRPC services. It generates production-ready database access code,
// GraphQL schemas/resolvers, and gRPC proto definitions from declarative schema
// definitions written in Go.
//
// # Schema Definition
//
