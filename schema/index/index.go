// Package index provides builders for defining entity indexes.
package index
...
// Fields sets the fields of the index, replacing any previously set fields.
// To define a composite index on both fields and edges, call Fields and Edges
// in a single chain:
//
//	func (T) Indexes() []velox.Index {
//
...
//	}
//
// Note: calling Fields multiple times overwrites (does not append) the field list.
// Pass all desired fields in a single call.
...
//		index.Fields("name").
//			Annotations(sqlschema.Prefix(100))
//
//	}
