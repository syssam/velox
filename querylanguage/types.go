...
// BoolNil applies the Nil operation on the given field.
func BoolNil() BoolP {
	field := &Field{}
...
// BoolNotNil applies the NotNil operation on the given field.
...
// BytesNil applies the Nil operation on the given field.
...
// BytesNotNil applies the NotNil operation on the given field.
...
// TimeNil applies the Nil operation on the given field.
func TimeNil() TimeP {
	field := &Field{}
	done := func(name string) { field.Name = name }
...
// TimeNotNil applies the NotNil operation on the given field.
...
// TimeIn returns a predicate to check if the field value matches any value in the given list.
func TimeIn(vs ...time.Time) TimeP {
	field := &Field{}
	...
	return &timeP{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// TimeNotIn returns a predicate to check if the field value doesn't match any value in the given list.
func TimeNotIn(vs ...time.Time) TimeP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &timeP{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// UintNil applies the Nil operation on the given field.
func UintNil() UintP {
	field := &Field{}
	done := func(name string) { field.Name = name }
...
// UintNotNil applies the NotNil operation on the given field.
...
// UintIn returns a predicate to check if the field value matches any value in the given list.
func UintIn(vs ...uint) UintP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uintP{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// UintNotIn returns a predicate to check if the field value doesn't match any value in the given list.
func UintNotIn(vs ...uint) UintP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uintP{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Uint8Nil applies the Nil operation on the given field.
...
// Uint8NotNil applies the NotNil operation on the given field.
...
// Uint8In returns a predicate to check if the field value matches any value in the given list.
func Uint8In(vs ...uint8) Uint8P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint8P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Uint8NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Uint8NotIn(vs ...uint8) Uint8P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint8P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Uint16Nil applies the Nil operation on the given field.
...
// Uint16NotNil applies the NotNil operation on the given field.
...
// Uint16In returns a predicate to check if the field value matches any value in the given list.
func Uint16In(vs ...uint16) Uint16P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint16P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Uint16NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Uint16NotIn(vs ...uint16) Uint16P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint16P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Uint32Nil applies the Nil operation on the given field.
...
// Uint32NotNil applies the NotNil operation on the given field.
...
// Uint32In returns a predicate to check if the field value matches any value in the given list.
func Uint32In(vs ...uint32) Uint32P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint32P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Uint32NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Uint32NotIn(vs ...uint32) Uint32P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint32P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Uint64Nil applies the Nil operation on the given field.
...
// Uint64NotNil applies the NotNil operation on the given field.
...
// Uint64In returns a predicate to check if the field value matches any value in the given list.
func Uint64In(vs ...uint64) Uint64P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint64P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Uint64NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Uint64NotIn(vs ...uint64) Uint64P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &uint64P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// IntNil applies the Nil operation on the given field.
func IntNil() IntP {
	field := &Field{}
	done := func(name string) { field.Name = name }
...
// IntNotNil applies the NotNil operation on the given field.
func IntNotNil() IntP {
	field := &Field{}
	done := func(name string) { field.Name = name }
...
// IntIn returns a predicate to check if the field value matches any value in the given list.
func IntIn(vs ...int) IntP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &intP{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// IntNotIn returns a predicate to check if the field value doesn't match any value in the given list.
func IntNotIn(vs ...int) IntP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &intP{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Int8Nil applies the Nil operation on the given field.
func Int8Nil() Int8P {
	field := &Field{}
	done := func(name string) { field.Name = name }
...
// Int8NotNil applies the NotNil operation on the given field.
...
// Int8In returns a predicate to check if the field value matches any value in the given list.
func Int8In(vs ...int8) Int8P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int8P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Int8NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Int8NotIn(vs ...int8) Int8P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int8P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Int16Nil applies the Nil operation on the given field.
...
// Int16NotNil applies the NotNil operation on the given field.
...
// Int16In returns a predicate to check if the field value matches any value in the given list.
func Int16In(vs ...int16) Int16P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int16P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Int16NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Int16NotIn(vs ...int16) Int16P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int16P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Int32Nil applies the Nil operation on the given field.
...
// Int32NotNil applies the NotNil operation on the given field.
...
// Int32In returns a predicate to check if the field value matches any value in the given list.
func Int32In(vs ...int32) Int32P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int32P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Int32NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Int32NotIn(vs ...int32) Int32P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int32P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Int64Nil applies the Nil operation on the given field.
...
// Int64NotNil applies the NotNil operation on the given field.
...
// Int64In returns a predicate to check if the field value matches any value in the given list.
func Int64In(vs ...int64) Int64P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int64P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Int64NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Int64NotIn(vs ...int64) Int64P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &int64P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Float32Nil applies the Nil operation on the given field.
...
// Float32NotNil applies the NotNil operation on the given field.
...
// Float32In returns a predicate to check if the field value matches any value in the given list.
func Float32In(vs ...float32) Float32P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &float32P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Float32NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Float32NotIn(vs ...float32) Float32P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &float32P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// Float64Nil applies the Nil operation on the given field.
...
// Float64NotNil applies the NotNil operation on the given field.
...
// Float64In returns a predicate to check if the field value matches any value in the given list.
func Float64In(vs ...float64) Float64P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &float64P{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// Float64NotIn returns a predicate to check if the field value doesn't match any value in the given list.
func Float64NotIn(vs ...float64) Float64P {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &float64P{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// StringNil applies the Nil operation on the given field.
...
// StringNotNil applies the NotNil operation on the given field.
...
// StringIn returns a predicate to check if the field value matches any value in the given list.
func StringIn(vs ...string) StringP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &stringP{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// StringNotIn returns a predicate to check if the field value doesn't match any value in the given list.
func StringNotIn(vs ...string) StringP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &stringP{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}

// StringContains returns a predicate to check if the field value contains the given substring.
func StringContains(substr string) StringP {
	field := &Field{}
	done := func(name string) { field.Name = name }
	return &stringP{P: &CallExpr{Func: FuncContains, Args: []Expr{field, &Value{V: substr}}}, done: done}
}

// StringContainsFold returns a predicate to check if the field value contains the given substring under case-folding.
func StringContainsFold(substr string) StringP {
	field := &Field{}
	done := func(name string) { field.Name = name }
	return &stringP{P: &CallExpr{Func: FuncContainsFold, Args: []Expr{field, &Value{V: substr}}}, done: done}
}

// StringEqualFold returns a predicate to check if the field equals the given string under case-folding.
func StringEqualFold(v string) StringP {
	field := &Field{}
	done := func(name string) { field.Name = name }
	return &stringP{P: &CallExpr{Func: FuncEqualFold, Args: []Expr{field, &Value{V: v}}}, done: done}
}

// StringHasPrefix returns a predicate to check if the field starts with the given prefix.
func StringHasPrefix(prefix string) StringP {
	field := &Field{}
	done := func(name string) { field.Name = name }
	return &stringP{P: &CallExpr{Func: FuncHasPrefix, Args: []Expr{field, &Value{V: prefix}}}, done: done}
}

// StringHasSuffix returns a predicate to check if the field ends with the given suffix.
func StringHasSuffix(suffix string) StringP {
	field := &Field{}
	done := func(name string) { field.Name = name }
	return &stringP{P: &CallExpr{Func: FuncHasSuffix, Args: []Expr{field, &Value{V: suffix}}}, done: done}
}
...
// ValueNil applies the Nil operation on the given field.
...
// ValueNotNil applies the NotNil operation on the given field.
...
// ValueIn returns a predicate to check if the field value matches any value in the given list.
func ValueIn(vs ...driver.Valuer) ValueP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &valueP{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// ValueNotIn returns a predicate to check if the field value doesn't match any value in the given list.
func ValueNotIn(vs ...driver.Valuer) ValueP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &valueP{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
...
// OtherNil applies the Nil operation on the given field.
...
// OtherNotNil applies the NotNil operation on the given field.
...
// OtherIn returns a predicate to check if the field value matches any value in the given list.
func OtherIn(vs ...driver.Valuer) OtherP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &otherP{P: &BinaryExpr{Op: OpIn, X: field, Y: &Value{V: args}}, done: done}
}

// OtherNotIn returns a predicate to check if the field value doesn't match any value in the given list.
func OtherNotIn(vs ...driver.Valuer) OtherP {
	field := &Field{}
	args := make([]any, len(vs))
	for i := range vs {
		args[i] = vs[i]
	...
	return &otherP{P: &BinaryExpr{Op: OpNotIn, X: field, Y: &Value{V: args}}, done: done}
}
